...
class VillagePolicy
{
     ...
     */
    public function view(User $user, Village $model): bool
    {
     ...
     */
    public function update(User $user, Village $model): bool
    {
     ...
     */
    public function delete(User $user, Village $model): bool
    {
     ...
     */
    public function restore(User $user, Village $model): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, Village $model): bool
    {
        return false;
    }
}
