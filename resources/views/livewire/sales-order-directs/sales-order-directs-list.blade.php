            ...
            <div class="flex flex-wrap justify-between mt-1">
                <div class="mt-1 md:w-1/2">
                    @role('super-admin|manager')
                        ...
                        <x-buttons.green wire:click.prevent="markAllAsTelahDikirim">Telah Dikirim</x-buttons.green>
                        <x-buttons.green wire:click.prevent="markAllAsSelesai">Selesai</x-buttons.green>
                    @endrole
                </div>
