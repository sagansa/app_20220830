    ...
    <x-tables.card-overflow>
        <x-table>
            <x-slot name="head">
                <tr>
                    <x-tables.th-left>
                        @lang('crud.invoice_purchase_closing_stores.inputs.closing_store_id')
                    </x-tables.th-left>
                    <th></th>
                </tr>
            </x-slot>
            <x-slot name="body">
                @foreach ($invoicePurchaseClosingStores as $closingStore)
                ...
                <tr>
                    <td colspan="2">
                        <div class="px-4 mt-10">
                            {{ $invoicePurchaseClosingStores->render() }}
                        </div>
                    </td>
                </tr>
            </x-slot>
