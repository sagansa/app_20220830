    ...
    <x-modal wire:model="showingModal">
        <div class="px-6 py-4">
            ...
            <div class="mt-5">
                <div>
                    <x-input.select
                        name="fuel_service_id"
                        label="Fuel Service"
                        wire:model="fuel_service_id"
                    >
            ...
            <thead class="text-gray-700">
                <tr>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.transfer_fuel_service.inputs.fuel_service_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
            <tbody class="text-gray-600">
                @foreach ($transferFuelService as $fuelService)
