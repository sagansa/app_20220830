<div x-show="isOpen" class="fixed inset-0 z-40 flex" role="dialog" aria-modal="true">
    ...
    <div x-show="isOpen" x-transition:enter="transition ease-in-out duration-300 transform"
        ...
        class="relative flex flex-col flex-1 w-full max-w-xs pt-5 pb-4 bg-white dark:bg-gray-900">
