 <footer aria-labelledby="footer-heading" class="bg-gray-900">
     ...
     <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
             ...
             <div class="mt-12 md:mt-16 xl:mt-0">
                 ...
                 <form class="flex mt-2 sm:max-w-md">
                     ...
                     <div class="flex-shrink-0 ml-4">
                         <button type="submit"
                             class="flex items-center justify-center w-full px-4 py-2 text-base font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-900">Sign
                             up</button>
                     </div>
                 </form>
             </div>
         ...
         <div class="py-10 border-t border-gray-800">
             <p class="text-sm text-gray-400">Copyright &copy; 2022 PT Asa Pangan Bangsa</p>
         </div>
     </div>
 </footer>
