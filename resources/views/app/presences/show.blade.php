        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-partials.card>
                ...
                <x-shows.dl>
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.presences.inputs.closing_store_id')</x-shows.dt
                        >
                        <x-shows.dd
                    ...
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.presences.inputs.amount')</x-shows.dt
                        >
                        <x-shows.dd>{{ $presence->amount ?? '-' }}</x-shows.dd>
                    </x-shows.sub-dl>
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.presences.inputs.payment_type_id')</x-shows.dt
                        >
                        <x-shows.dd
