...
<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.transfer_fuel_services.edit_title')
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-partials.card>
                ...
                <x-form
                    method="PUT"
                    action="{{ route('transfer-fuel-services.update', $transferFuelService) }}"
                    has-files
                    class="mt-4"
                >
                    @include('app.transfer_fuel_services.form-inputs')
...
@else
<x-admin-layout>
    <a href="{{ route('transfer-fuel-services.index') }}" class="button">
