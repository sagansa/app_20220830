        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-partials.card>
                ...
                <x-shows.dl>
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.carts.inputs.e_product_id')</x-shows.dt
                        >
                        <x-shows.dd
                    ...
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.carts.inputs.quantity')</x-shows.dt
                        >
                        <x-shows.dd>{{ $cart->quantity ?? '-' }}</x-shows.dd>
                    </x-shows.sub-dl>
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.carts.inputs.user_id')</x-shows.dt
                        >
                        <x-shows.dd
