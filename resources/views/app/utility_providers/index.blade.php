<x-admin-layout>
    ...
    <x-tables.card>
        <x-table>
            <x-slot name="head">
                <x-tables.th-left
                    >@lang('crud.utility_providers.inputs.name')</x-tables.th-left
                >
                <x-tables.th-left
                    >@lang('crud.utility_providers.inputs.category')</x-tables.th-left
                >
                <th></th>
            </x-slot>
            <x-slot name="body">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 text-center" style="width: 134px;">
                        ...
                        >
                            ...
                            <a
                                href="{{ route('utility-providers.edit', $utilityProvider) }}"
                                class="mr-1"
                            >
                            ...
                            <a
                                href="{{ route('utility-providers.show', $utilityProvider) }}"
                                class="mr-1"
                            >
                            ...
                            <form
                                action="{{ route('utility-providers.destroy', $utilityProvider) }}"
                                method="POST"
    ...
    <div class="mt-10 px-4">{!! $utilityProviders->render() !!}</div>
</x-admin-layout>
